...
######################################################################
# A script to create some self signed certificates for the gke deployment
######################################################################
...
#
ROOT_CERT_FILE_PREFIX='example.gke.ca'
ROOT_CERT_DESCRIPTION='Self Signed CA for example.gke'
SSL_CERT_FILE_PREFIX='example.gke.ssl'
WILDCARD_DOMAIN_NAME='*.example.gke'
